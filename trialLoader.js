...
function biggify(group, id){
  ...
  document.getElementById("all").innerHTML += "<div id=\"Current\" class=\"Current\" onclick=\"destroyCurrent()\"> <img src=\""+a+"\" id=\"BigView\" class=\"BigView\" style=\"text-align:center;\"/ ></div>"
